...
export function QueueSummaryCard({ label, value, updatedAt, status }: QueueSummaryCardProps) {
  return (
    <article className="rounded-[10px] border border-[#334155] bg-panel p-[14px] shadow-[0_0_0_1px_#1F2937] transition-all duration-150 ease-in hover:bg-[#243245]">
      ...
      <div className="mt-4 text-[30px] font-bold leading-none text-primary">{value}</div>
    </article>
  );
}
