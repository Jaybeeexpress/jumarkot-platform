            ...
            <div className="space-y-4">
              <div className="rounded-[1.5rem] border border-[var(--line)] bg-[var(--card-strong)] p-5">
                ...
                <ul className="mt-4 space-y-3 text-sm leading-6 text-slate-700">
                  ...
                  <li>Strict API-key authorization requiring the <span className="font-mono">events:write</span> scope.</li>
                  <li>Developer-portal sandbox that submits real payloads through a server-side proxy.</li>
                </ul>
              </div>
              ...
              <div className="rounded-[1.5rem] border border-[var(--line)] bg-slate-950 p-5 text-slate-100">
                ...
                <ol className="mt-4 space-y-3 text-sm leading-6 text-slate-300">
                  <li>Generate a sandbox API key with the <span className="font-mono">events:write</span> scope from identity-access-service.</li>
                  <li>Set <span className="font-mono">EVENT_INGESTION_SERVICE_URL</span> to your local ingestion service.</li>
                  <li>Use the form or curl preview to submit a sample event and inspect the acceptance response.</li>
                </ol>
              </div>
            </div>
        ...
        <section className="rounded-[2rem] border border-[var(--line)] bg-[var(--card)] p-6 shadow-[0_24px_80px_rgba(15,23,42,0.08)] backdrop-blur md:p-8">
          ...
          <div className="mt-6 space-y-4">
            ...
            <button
              ...
              className="w-full rounded-[1.5rem] bg-[var(--brand-strong)] px-5 py-4 text-sm font-semibold uppercase tracking-[0.16em] text-white transition hover:bg-[var(--brand)] disabled:cursor-not-allowed disabled:opacity-60"
            >
